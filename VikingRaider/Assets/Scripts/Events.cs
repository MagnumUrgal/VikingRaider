...
public class Events : MonoBehaviour
{
    ...
    public Events(int _nbRound, int _modifAtk, int _modifDef,
        int _modifMoral, int _modifIntim, int _id, string _description)
    {
        nbRound = _nbRound;
        modifAtk = _modifAtk;
        modifDef = _modifDef;
...
{
    public vikingEvents(int _nbRound, int _modifAtk, int _modifDef, int _modifMoral,
        int _modifIntim, int _id, string _description) : 
        base(_nbRound, _modifAtk, _modifDef, _modifMoral, _modifIntim, _id, _description)
    {}
}
...
public class townEvents : Events
{
    ...
    public townEvents(int _nbRound, int _modifAtk, int _modifDef, 
        ...
        int _modifPerc, float _modifProd, float _modifFear, int _id, string _description) :
        base(_nbRound, _modifAtk, _modifDef, _modifMoral, _modifIntim, _id, _description)
    {
